...
namespace ClarionWindowFormatter.Dialogs
{
    public class WindowFormatterSettingsDialog : Form
    {
        ...
        private void BuildUI()
        {
            ...
            _txtApiKey = new TextBox { Location = new Point(200, y), Width = 290, PasswordChar = '*' };
            content.Controls.Add(_txtApiKey);
            y += 28;

            content.Controls.Add(new Label { Text = "Modelo:", Location = new Point(12, y + 2), AutoSize = true });
            _txtAiModel = new TextBox { Location = new Point(200, y), Width = 290 };
            ...
            var lblModels = new Label
            {
                ...
                Location  = new Point(200, y), Width = 290, Height = 18,
            ...
            _txtProtocolFile = new TextBox { Location = new Point(200, y), Width = 220 };
            content.Controls.Add(_txtProtocolFile);

            var btnBrowse = new Button { Text = "...", Location = new Point(425, y - 1), Width = 28, Height = 22 };
            btnBrowse.Click += OnBrowseProtocol;
            content.Controls.Add(btnBrowse);

            var btnEdit = new Button { Text = "Editar", Location = new Point(457, y - 1), Width = 50, Height = 22 };
            ...
            {
                Text      = "Si no se indica, usa Protocolo_WindowFormatter.md en %APPDATA%\\ClarionAssistant\\",
                Location  = new Point(200, y), Width = 290, Height = 28,
                Font      = new Font(Font, FontStyle.Italic), ForeColor = Color.Gray
            };
            ...
            btnOk.Size = new Size(90, 26); btnOk.Location = new Point(338, 7);
            btnOk.Click += (s, e) => SaveValues();

            var btnCancel = new Button { Text = "Cancelar", DialogResult = DialogResult.Cancel };
            btnCancel.Size = new Size(90, 26); btnCancel.Location = new Point(434, 7);
        ...
        private void OnNewProfile(object s, EventArgs e)
        {
            ...
            var newP = new WindowFormatterProfile { ProfileName = name, AiProtocolFile = _current.AiProtocolFile };
        ...
        private void OnEditProtocol(object s, EventArgs e)
        {
            ...
            if (string.IsNullOrWhiteSpace(path))
            {
                ...
                path = System.IO.Path.Combine(appData, "ClarionAssistant", "Protocolo_WindowFormatter.md");
